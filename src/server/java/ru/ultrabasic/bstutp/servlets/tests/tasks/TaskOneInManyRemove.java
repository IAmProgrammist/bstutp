...
@WebServlet("/api/tests/tasks/oneinmany/delete")
public class TaskOneInManyRemove extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            ...
            int questionId = jsonStart.getInt("idQuestion");

            if (SQLHandler.getState(userId, testId) == TestState.DRAFT)
                SQLHandler.oneInManyRemoveQuestion(taskId, questionId);
